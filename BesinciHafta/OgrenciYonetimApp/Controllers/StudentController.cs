...
using OgrenciYonetimApp.Models; // Modeli çağırıyoruz
using OgrenciYonetimApp.Data;   // Repository'i çağırıyoruz

namespace OgrenciYonetimApp.Controllers // Kendi proje Namespace'inizi kullanın
{
